...
class Base_Agent(object):
    ...
    def reset_game(self):
        ...
        self.state, self.mask = self.environment.reset(save_data=True)
    ...
    def run_n_episodes(self, prof=None, num_episodes=None, show_whether_achieved_goal=True, save_and_print_results=True):
