...
config = Config()
config.environment = sdnSync_SP(numStates=7, numActions=7, budget=2, numSteps = 300)  #900

config.seed = 123453
config.num_episodes_to_run = 300  #1
...
config.hyperparameters = {
    "DQN_Agents": {
        ...
        "discount_rate": 0.001,  #0.99,
        "tau": 0.01,


        "update_every_n_steps": 1,
        "linear_hidden_units": [100,200],
...
if __name__ == "__main__":
    AGENTS = [DDQN]  #[DDQN]  #[SAC_Discrete, DDQN, Dueling_DDQN, DQN, DQN_With_Fixed_Q_Targets,
